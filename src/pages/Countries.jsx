  ...
  return (
    <>
      ...
      <div className="search-container">
        <input type="text" value={searchInput} placeholder="Country Filter" onChange={onInputChange} />
        <input type="text" value={continentSearchInput} placeholder="Continent Filter" onChange={onInputContinentChange} />
      </div>
